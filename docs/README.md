...
[API Reference](../book/rustdoc/rustebra/index.html) · [Architecture](archived/adr/index.md) · [GitHub](https://github.com/tec-eli/rustebra)
...
- **[Architecture Decisions](archived/adr/index.md)** — design choices and trade-offs
